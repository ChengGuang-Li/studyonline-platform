...
/**
 * ：This file serves as a video file processing parent class, providing
 * 1、View video duration
 * 2、Verify whether the duration of two videos is equal
 *
 */
public class VideoUtil {
    ...
    //Check whether the video time is consistent
    ...
    //Get video time (hour: minute: second: millisecond)
    ...
    public static void main(String[] args) throws IOException {
        ...
        String video_time = videoUtil.get_video_time("D:\\Download\\test1.avi");
