...
public class CommonUtil {
	...
	/**
	 * Maps underscores to regular expressions used in camel naming. Precompiled regular expressions are used to improve efficiency.
	 */
	private static Pattern patternForUTC = Pattern.compile("_([a-z]){1}");

	/**
	 * Map underscore to camel naming
	 *
	 * @param str
	 * @return
	 */
	...
	/**
	 * Mapping camel naming to underscores must be standard camel case naming, otherwise strange results will occur.
	 *
	 * @param str
	 * @return
	 */
